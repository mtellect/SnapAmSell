...
class _ReportMainState extends State<ReportMain> with TickerProviderStateMixin {
  ...
  reportItem(BaseModel m) {
    ...
    bool disabled = appSettingsModel.getList(DISABLED).contains((bm.getObjectId()));
      ...
      children: <Widget>[
        type == REPORT_TYPE_PROFILE
          ...
          child: GestureDetector(
            ...
            onLongPress: (){
              showListDialog(context, ["Mark Completed","Show My Accounts",disabled?"Enable":"Disable",banned?"Unban":"Ban"], (int p){
                if (p==0) {
                  showMessage(context, Icons.check, blue0, "Mark Report?",
                      ...
                      clickNoText: "Cancel", onClicked: (_) {
                        if (_ == true) {
                          ...
                          m.updateItems();
                          reportItems
                              .removeWhere((bm) => bm.getObjectId() == m.getObjectId());
                          setState(() {});
                        }
                      });
                }
...
//                  pushAndResult(context, ShowAllfromIds(bm.getString(DEVICE_ID)));
                ...
                if(p==2){
                  yesNoDialog(context, "${disabled?"Enable":"Disable"} Account?", "Are you sure?", (){
                    appSettingsModel.putInList(DISABLED, bm.getObjectId(), !disabled);
                ...
                if(p==3){
                  yesNoDialog(context, "${banned?"Unban":"Ban"} Account?", "Are you sure?", (){
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            getFullName(bm),
                            style: textStyle(false, 20, white,),maxLines: 2,
                          ),
//                          Text(
//                            bm.getString(CITY),
...
//                          ),
                          Text(
                            ...
                            style: textStyle(true, 12, white.withOpacity(.5),),maxLines: 1,overflow: TextOverflow.ellipsis,
                          ),
