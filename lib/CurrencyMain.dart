...
class _CurrencyMainState extends State<CurrencyMain>
  ...
  loadItems() async {
    QuerySnapshot shots =
        await Firestore.instance.collection(CURRENCY_BASE).getDocuments();
                            ...
                            child: Card(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      bm.getString(CURRENCY),
                                      style: textStyle(
                                          true, 25, black.withOpacity(.5)),
                                    ),
                                    addSpace(10),
                                    GestureDetector(
                                      onTap: () {
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                                ...
                                                width: .5)),
                                        child: Text(
                                          "Dollar Rate: ${bm.getDouble(IN_USD)}",
                                          style: textStyle(
                                              true,
                                              14,
                                              bm.getDouble(IN_USD) == 0
                                                  ? black
                                                  : white),
                                        ),
                                      ),
                                      ...
                                      SingleChildScrollView(
                                        ...
                                        child: Row(
                                          children: List.generate(
                                            ...
                                            String name = CountryPickerUtils
                                                    .getCountryByIsoCode(code)
                                                .name;
