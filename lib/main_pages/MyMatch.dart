...
class _MyMatchState extends State<MyMatch> with AutomaticKeepAliveClientMixin {
  List peopleList = [];
  bool setup = false;
  @override
  void initState() {
  ...
  page() {
    ...
    if (peopleList.isEmpty)
      return emptyLayout(Icons.person, "No Match Yet", "");
    return Container(
